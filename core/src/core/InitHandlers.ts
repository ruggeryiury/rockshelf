...
import { addHandler, getRB3Data, installHighMemoryPatch, installQuickConfig, openUserData, readUserConfig, saveUserConfig, selectDevhdd0Folder, SelectPKGFile, selectRPCS3Exe, winClose, winMaximize, winMinimize } from '../lib'
