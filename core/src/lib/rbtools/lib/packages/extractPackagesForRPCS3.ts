import { type DirPath, type DirPathLikeTypes, pathLikeToDirPath, pathLikeToFilePath } from 'node-lib'
 ...
 */
export const extractPackagesForRPCS3 = async (packages: RB3PackageLikeType[], devhdd0DirPath: DirPathLikeTypes, packageFolderName: string, options?: RPCS3ExtractionOptions): Promise<RPCS3PackageExtractionObject> => {
