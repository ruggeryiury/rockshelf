      ...
      {message && (
        <>
          <div className="w-full flex-row! items-start">
            {message.type === 'loading' && <LoadingIcon className="mt-0.5 mr-2 min-w-8 animate-spin text-xl" />}
            ...
            <div className="w-full">
              <h1 className="mb-1 w-full border-b border-neutral-800 pb-1 text-lg uppercase">{t(message.type)}</h1>
