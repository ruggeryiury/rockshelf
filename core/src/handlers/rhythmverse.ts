...
import { RhythmverseAPI, rhythmverseAPISourceURL, rhythmverseOptsLocale, type ProcessedRhythmverseObject, type RawRhythmverseResponse, type RhythmverseFetchingOptions } from '../lib/rbtools'

export type RhythmverseDataFetchingTypes = 'text' | 'artist'

export const rhythmverseFetchData = useHandler(async (_, __, searchField: string, type: RhythmverseDataFetchingTypes, options?: RhythmverseFetchingOptions): Promise<ProcessedRhythmverseObject> => {
