...
- Rockshelf is not able to read, install or edit Rock Band/Rock Band 2 song packages.
  - _Rockshelf uses a hand-made DTA parser written in JavaScript that can't process Rock Band/Rock Band 2 DTA values. Rockshelf's DTA Parser was written to parse exclusively Rock Band 3 DTAs from customs generated by MAGMA, or DTAs from Rock Band 3 or newer._
