...
import { type AllHashAlgorithms, type FilePath, type FilePathLikeTypes, createHashFromBuffer, pathLikeToFilePath } from 'node-lib'
import type { BinaryToTextEncoding } from 'node:crypto'
import type { WriteStream } from 'node:fs'
import { inspect } from 'node:util'
import { temporaryFile } from 'tempy'

import { type DTAFileBatchUpdateObject, type DTAFileUpdateObject, type DTAStringifyOptions, type RB3CompatibleDTAFile, type SongDataCreationObject, type SongSortingTypes, createDTA, depackDTAContents, genNumericSongID, genTracksCountArray, isRB3CompatibleDTA, parseDTA, rockshelfDTAUpdates, sortDTA, stringifyDTA } from '../lib.exports'
...
export class DTAParser {
	...
	async applyDXUpdatesOnSongs(deleteNonAppliedUpdates: boolean = true, fetchUpdates: boolean = false): Promise<string[]> {
		const updatesLinks = [
			'https://raw.githubusercontent.com/hmxmilohax/rock-band-3-deluxe/refs/heads/develop/_ark/dx/song_updates/official_additional_metadata.dta',
			'https://raw.githubusercontent.com/hmxmilohax/rock-band-3-deluxe/refs/heads/develop/_ark/dx/song_updates/unofficial_additional_metadata.dta',
			'https://raw.githubusercontent.com/hmxmilohax/rock-band-3-deluxe/refs/heads/develop/_ark/dx/song_updates/metadata_updates.dta',
			'https://raw.githubusercontent.com/hmxmilohax/rock-band-3-deluxe/refs/heads/develop/_ark/dx/song_updates/rbhp_upgrades.dta',
			'https://raw.githubusercontent.com/hmxmilohax/rock-band-3-deluxe/refs/heads/develop/_ark/dx/song_updates/harms_and_updates.dta',
			'https://raw.githubusercontent.com/hmxmilohax/rock-band-3-deluxe/refs/heads/develop/_ark/dx/song_updates/rb_plus_upgrades.dta',
			'https://raw.githubusercontent.com/hmxmilohax/rock-band-3-deluxe/refs/heads/develop/_ark/dx/song_updates/vanilla.dta',
			'https://raw.githubusercontent.com/hmxmilohax/rock-band-3-deluxe/refs/heads/develop/_ark/dx/song_updates/loading_phrases.dta',
		]
