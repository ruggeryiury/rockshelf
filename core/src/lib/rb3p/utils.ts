...
/**
 * Calculates all the file sizes from a song in a song package.
 * - - - -
 * @param {DirPathLikeTypes} packageDirPath The song package path.
 * @param {string} songname The internal songname of the song you want to calculate the file sizes from.
 * @returns {Promise<SongFilesSizeObject>}
 */
