import { DirPath, type FilePathLikeTypes, pathLikeToDirPath, pathLikeToFilePath } from 'node-lib'
import { temporaryDirectory, temporaryFile } from 'tempy'
import type { LiteralUnion } from 'type-fest'
import { useDefaultOptions } from 'use-default-options'
import { stringify as stringifyYAML } from 'yaml'

import { ImageFile, OnyxCLI, PythonAPI, type RB3PackageLikeType, RBTools, STFSFile, type SelectedSongForExtractionObject, TextureFile } from '../../core.exports'
import { type DTAFileBatchUpdateObject, type DTAFileUpdateObject, type STFSPackageExtractionObject, extractPackagesForExtractedSTFS } from '../../lib.exports'
