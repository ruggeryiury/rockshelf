...
import { DirPath, type DirPathLikeTypes, type FilePathLikeTypes, createHashFromBuffer, pathLikeToDirPath } from 'node-lib'
import { createReadStream } from 'node:fs'
import { pipeline } from 'node:stream/promises'
import { useDefaultOptions } from 'use-default-options'

import { type RB3SongPackagesDataObject, RockshelfFileSystemAPI, sendBuzyLoad, sendMessageBox } from '../../core.exports'
import { userData } from '../../init'
import { genRPCS3SongPackageManifest } from '../../lib.exports'
import { EDATFile } from '../rbtools'
import { getUnpackedFilesPathFromRootExtraction } from '../rbtools/lib.exports'
