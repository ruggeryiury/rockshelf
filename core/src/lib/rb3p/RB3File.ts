import { BinaryReader, DirPath, type DirPathLikeTypes, type FilePath, type FilePathJSONRepresentation, type FilePathLikeTypes, pathLikeToDirPath, pathLikeToFilePath } from 'node-lib'

import { type RB3FileHeaderObject, RB3_HEADER_SIZE, RB3_SONG_ENTRY_SIZE, createRSPackImage, extractFilesFromRB3File, parseRB3FileHeader } from '../../lib.exports'
