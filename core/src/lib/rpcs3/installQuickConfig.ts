...
export const installQuickConfig = useHandlerWithUserConfig(async (win, _, { rpcs3ExePath }, configType: QuickConfigType): Promise<boolean> => {
  const configYmlFile = FileSystem.packageBinDir.gotoFile(`rpcs3config/${configType}.yml`)
