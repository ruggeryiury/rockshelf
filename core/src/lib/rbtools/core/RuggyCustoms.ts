import { type RB3CompatibleDTAFile, sortDTA } from '../lib.exports'
import { DTAParser } from './DTAParser'
import type { MAGMAProjectSongData } from './MAGMAProject'
...
export class RuggyCustoms {
	...
	static songs = (): RB3CompatibleDTAFile[] =>
		[
			DTAParser.create({
				id: '7748paintwar',
				name: 'Paint War',
			...
			DTAParser.create({
				...
				albumName: 'Pista Livre',
				albumTrackNumber: 10,
				songID: 53,
				genre: { genre: 'Pop-Rock', subGenre: 'Soft Rock' },
				backingTracksCount: 1,
				bandRank: 1,
				drum: { channels: 5, rank: 0 },
				bass: { channels: 1, rank: 0 },
				guitar: { channels: 2, rank: 3, rankPRO: 1 },
				vocals: { channels: 2, rank: 2, vocalParts: 3 },
				keys: { channels: 2, rank: 2, rankPRO: 2 },
				rating: 'Family Friendly',
				bank: 'Tambourine',
				animTempo: 'Slow (under 100bpm)',
