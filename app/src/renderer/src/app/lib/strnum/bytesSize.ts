 ...
 * - ≥ 1000 GB → TB
 * - - - -
 * @param {number} input A Buffer, ArrayBuffer, or number of bytes.
 ...
 */
export const getReadableBytesSize = (input: number): string => {
  if (input < 1024 * 1024) return (input / 1024).toFixed(2) + 'KB'
  else if (input < 1000 * 1024 * 1024) return (input / (1024 * 1024)).toFixed(2) + 'MB'
  else if (input < 1000 * 1024 * 1024 * 1024) return (input / (1024 * 1024 * 1024)).toFixed(2) + 'GB'
  else return (input / (1024 * 1024 * 1024 * 1024)).toFixed(2) + 'TB'
}
