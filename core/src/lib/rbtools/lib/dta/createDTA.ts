...
import { type AnimTempoNames, type BandFailCueNames, type BandRankingNames, type BandRankingNumbers, type CustomSourceValuesObject, type DrumBankNames, type MAGMALanguagesTypes, type PercussionBankNames, type RB3CompatibleDTAFile, type SoloFlags, type SongGameOriginNames, type SongGenreNames, type SongRatingNames, type SongScrollSpeedNames, type VocalGenderNames, type VocalParts, type VocalPartsNames, bandAverageRankCalculator, channelsCountToPanArray, dta, genNumericSongID, rankValuesToDTARankSystem } from '../../lib.exports'
...
export type SubGenreUpdateValues<G extends SongGenreNames> = G extends 'Classical' | 'Classic Rock' | 'Emo' | 'Fusion' | 'Grunge' | 'Inspirational' | 'J-Rock' | 'Latin' | 'Novelty' | 'Nu-Metal' | 'Southern Rock' | 'World'
	? G
