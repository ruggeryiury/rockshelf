...
import { PKGFile, type PKGFileJSONRepresentation, STFSFile, type STFSFileJSONRepresentation } from '../core.exports'
import { type RPCS3ExtractionOptions, type RPCS3PackageExtractionObject, type STFSCreationObject, type STFSCreationOptions, type STFSExtractionOptions, type STFSPackageExtractionObject, type UnpackedFilePathsFromSongObject, extractPackagesForExtractedSTFS, extractPackagesForRPCS3, extractPackagesForSTFSFile } from '../lib.exports'
...
export class RB3PackCreator {
	 ...
	 */
	async toRPCS3(devhdd0DirPath: DirPathLikeTypes, packageFolderName: string, options?: RPCS3ExtractionOptions): Promise<RPCS3PackageExtractionObject> {
		return await extractPackagesForRPCS3(this.packages, devhdd0DirPath, packageFolderName, options)
	}
